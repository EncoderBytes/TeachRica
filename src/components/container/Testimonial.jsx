    ...
    <div className='bg-gray h-auto py-36' id='testimonial'>
      <div className="flex items-center justify-center gap-2 ">
        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
          <path d="M33.6716 6.88947L7.32843 33.2326C4.80857 35.7525 0.5 33.9678 0.5 30.4042L0.499998 4.06104C0.499998 1.8519 2.29086 0.0610368 4.5 0.0610367L30.8431 0.0610356C34.4068 0.0610354 36.1914 4.36961 33.6716 6.88947Z" fill="#04989E" />
        </svg>
        <p className='font-bold text-3xl text-center '>What Our Client Say About Us</p>
      </div>
      ...
      <div className="w-5/6 m-auto items-center sm:flex-row flex flex-col py-28 gap-12">
        <div className=" sm:w-2/3 w-100">
          <div className="flex items-center gap-3">
            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
              <path d="M33.1716 7.41804L6.82843 33.7612C4.30857 36.281 -2.66344e-07 34.4964 -4.22114e-07 30.9327L-1.57361e-06 4.5896C-1.67017e-06 2.38046 1.79086 0.589601 4 0.589601L30.3431 0.5896C33.9068 0.5896 35.6914 4.89818 33.1716 7.41804Z" fill="#FFD15C" />
            </svg>
            <p className="font-bold text-3xl text-center">Best Tuition Services in Peshawar</p>
          </div>
        ...
        <div className=" mt-3 relative">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="252" height="252" viewBox="0 0 252 252" fill="none" className='absolute -bottom-4 -left-4 mix-blend-multiply'>
            <path d="M224.162 223.804L27.8733 27.5154C17.7939 17.4359 0.55963 24.5746 0.55963 38.829L0.559621 235.118C0.559621 243.955 7.72306 251.118 16.5596 251.118L212.849 251.118C227.103 251.118 234.242 233.884 224.162 223.804Z" fill="#04989E" />
          </svg>
        </div>
      </div>
